...
a high-performance, strongly-typed communication layer for FxMap’s Attribute-based Data Mapping, enabling streamlined data
...
`fxmap-request-topic-[fxmap.attribute.metadata]`, so you should avoid creating a topic with the same name in your
application.
...
| [FxMap-Kafka][FxMap-Kafka.nuget]                       | FxMap-Kafka is an extension package for FxMap that leverages Kafka for efficient data transportation.                       | 8.0, 9.0     | This Document                                                                            |
