...
namespace FxMap.Abstractions.Transporting;

/// <summary>
/// Defines the transport-agnostic client interface for sending requests in the FxMap framework.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// Instead of depending on a specific transport client, consumers of the FxMap framework
