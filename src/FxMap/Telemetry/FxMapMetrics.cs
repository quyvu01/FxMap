...
/// <summary>
/// Provides OpenTelemetry-compatible metrics for FxMap framework operations.
/// </summary>
/// <remarks>
...
/// </remarks>
public static class FxMapMetrics
{
    ...
    /// <summary>
    /// Total number of FxMap requests initiated.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Total number of FxMap request errors.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Duration of FxMap requests in milliseconds.
    /// </summary>
    /// <remarks>
    /// Recommended dimensions: attribute, transport, status
    /// </remarks>
    ...
    /// <summary>
    /// Current number of active FxMap requests.
    /// </summary>
    /// <remarks>
    ...
    public static void RecordMessageSend(string transport, string destination, long sizeBytes)
    {
        ...
        {
            { Constants.Telemetry.LabelFxMapTransport, transport },
            { Constants.Telemetry.LabelFxMapDestination, destination },
            { Constants.Telemetry.LabelFxMapDirection, Constants.Telemetry.DirectionSend }
        };
    ...
    public static void RecordMessageReceive(string transport, string source, long sizeBytes)
    {
        ...
        {
            { Constants.Telemetry.LabelFxMapTransport, transport },
            { Constants.Telemetry.LabelFxMapSource, source },
            { Constants.Telemetry.LabelFxMapDirection, Constants.Telemetry.DirectionReceive }
        };
    ...
    public static void RecordDatabaseQuery(string dbSystem, string operation, double durationMs)
    {
        ...
        {
            { Constants.Telemetry.LabelFxMapDbSystem, dbSystem },
            { Constants.Telemetry.LabelFxMapOperation, operation }
        };
    ...
    public static void RecordExpressionParsing(string expression, double durationMs)
    {
        ...
        var tags = new TagList { { Constants.Telemetry.LabelFxMapComplexity, complexity } };
