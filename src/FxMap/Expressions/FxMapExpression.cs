...
/// <summary>
/// Main entry point for parsing and building FxMap expressions.
/// </summary>
/// <remarks>
/// <para>
...
/// <code>
/// // Simple usage
/// var expr = FxMapExpression.Parse&lt;User&gt;("Country.Name");
/// var lambda = expr.ToLambda&lt;string&gt;();
///
/// // Complex query
/// var expr = FxMapExpression.Parse&lt;User&gt;("Orders(Status = 'Completed')[0 10 desc Total].{Id, Total}");
///
/// // With filter
...
public sealed class FxMapExpression<TModel>
{
    ...
    /// <summary>
    /// Parses an expression string and returns an FxMapExpression instance.
    /// </summary>
...
/// <summary>
/// Static helper class for FxMap expression operations.
/// </summary>
public static class FxMapExpression
{
    /// <summary>
