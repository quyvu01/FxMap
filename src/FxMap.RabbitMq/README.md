...
provides a high-performance, strongly-typed communication layer for FxMap's FluentAPI-based Data Mapping, enabling
...
| [FxMap.RabbitMq][FxMap.RabbitMq.nuget]                       | FxMap.RabbitMq is an extension package for FxMap that leverages RabbitMq for efficient data transportation.                 | 8.0, 9.0, 10.0 | This Document                                                                                |
