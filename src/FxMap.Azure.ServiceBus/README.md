...
This package provides a **strongly-typed**, **cloud-native** communication layer for FxMap’s **Attribute-based Data
...
`Note:` FxMap-Azure-ServiceBus uses message subjects that start with fxmap-request-[FxMapAttribute metadata].
