...
public class FxMapExpressionSyntaxAnalyzerTests
{
    ...
    public async Task ValidExpression_SimpleProperty_NoDiagnostic()
    {
        const string testCode = """
                                ...
                                namespace FxMap.Attributes
                                {
                                    public class FxMapAttribute(string propertyName) : Attribute
                                    {
                                        public string Expression { get; set; }
                                    }
                                }

                                public class CountryOfAttribute(string propertyName) : FxMap.Attributes.FxMapAttribute(propertyName);
    ...
    public async Task ValidExpression_WithRuntimeParameters_NoDiagnostic()
    {
        const string testCode = """
                                ...
                                public class MemberOfAttribute(string propertyName) : FxMap.Attributes.FxMapAttribute(propertyName);
    ...
    public async Task InvalidExpression_MissingDotAfterIndexer_ReportsDiagnostic()
    {
        const string testCode = """
                                ...
                                public class ProvinceOfAttribute(string propertyName) : FxMap.Attributes.FxMapAttribute(propertyName);
    ...
    public async Task InvalidExpression_MissingDotAfterFilter_ReportsDiagnostic()
    {
        const string testCode = """
                                ...
                                public class OrderOfAttribute(string propertyName) : FxMap.Attributes.FxMapAttribute(propertyName);
