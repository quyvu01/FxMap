...
public class FxMapRequestResponseContractTests
{
    ...
    public void FxMapDataResponse_Should_Serialize_And_Deserialize_Correctly()
    {
        ...
        deserialized.Values.Length.ShouldBe(2);
        deserialized.Values[0].Expression.ShouldBe("Name");
        deserialized.Values[1].Expression.ShouldBe("Email");
    }
    ...
    public void FxMapDataResponse_Should_Handle_Null_Values()
    {
        ...
        // Assert
        deserialized.ShouldNotBeNull();
        deserialized.Values[0].Value.ShouldBe("null");
    }

    [Fact]
    public void FxMapValueResponse_Should_Support_Complex_Json_Values()
    {
        // Arrange
    ...
    [Fact]
    public void FxMapRequest_Json_Format_Should_Remain_Stable()
    {
