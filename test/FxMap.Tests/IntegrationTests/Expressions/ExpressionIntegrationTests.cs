...
namespace FxMap.Tests.IntegrationTests.Expressions;

/// <summary>
/// Comprehensive integration tests for FxMap Expression system with in-memory DbContext.
...
public sealed class ExpressionIntegrationTests : IDisposable
{
    ...
    public async Task Transform_ConvertsRawResultsToFxMapDataResponse()
    {
        ...
        responses[0].Values.Length.ShouldBe(2);
        responses[0].Values[0].Expression.ShouldBe("Name");
        responses[0].Values[1].Expression.ShouldBe("Age");
    }
