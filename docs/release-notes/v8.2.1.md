# FxMap v8.2.1 Release Notes

**Release Date:** January 18, 2026

## Overview

FxMap v8.2.1 is a performance-focused release that introduces **parameterized query support** for EF Core, significantly improving database query plan caching and overall performance.
...
- `src/FxMap/Builders/FilterContext.cs` - New file
- `src/FxMap/Builders/QueryHandlerBuilder.cs` - Updated filter expression building
...
```bash
dotnet add package FxMap --version 8.2.1
```
