# FxMap v8.2.2 Release Notes

**Release Date:** January 18, 2026

## Overview

FxMap v8.2.2 is a stability release that fixes a critical **EF Core concurrency issue** caused by DbContext reuse across concurrent requests.
...
- `src/FxMap.EntityFrameworkCore/EfQueryHandler.cs` - Added scope creation per request
...
```bash
dotnet add package FxMap.EntityFrameworkCore --version 8.2.2
```
