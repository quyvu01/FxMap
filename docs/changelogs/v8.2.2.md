...
| File | Changes |
|------|---------|
| `src/FxMap.EntityFrameworkCore/EfQueryHandler.cs` | Added scope creation per request for DbContext isolation |
...
public async Task<FxMapDataResponse[]> HandleAsync(...)
{
