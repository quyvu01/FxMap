...
| File | Description |
|------|-------------|
| `src/FxMap/Builders/FilterContext.cs` | FilterContext base class and generic implementation |

### Modified Files

| File | Changes |
|------|---------|
| `src/FxMap/Builders/QueryHandlerBuilder.cs` | Added FilterContext support, compiled factory delegate |
