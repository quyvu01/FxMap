...
- **New Class: `src/FxMap/Helpers/ParameterConverter.cs`**
...
- **Optimized: `src/FxMap/Helpers/ReflectionHelpers.cs`**
...
- **New Exception: `src/FxMap/Exceptions/FxMapException.cs`**
...
- **New File: `src/FxMap/Properties/AssemblyInfo.cs`**
  - Added `InternalsVisibleTo` for `FxMap.Tests` assembly
  - Added `InternalsVisibleTo` for `FxMap.Benchmark` assembly
...
- **`test/FxMap.Tests/UnitTests/Helpers/ParameterConverterTests.cs`** (13 tests)
...
- **`test/FxMap.Tests/UnitTests/Helpers/ReflectionHelpersCircularReferenceTests.cs`** (19 tests)
...
- **`test/FxMap.Benchmark/FxMapBenchmarks/Reflections/DiscoverResolvablePropertiesBenchmark.cs`**
...
- **Modified: `src/FxMap/Implementations/DistributedMapper.cs`**
...
- **Modified: `src/FxMap/Helpers/ReflectionHelpers.cs`**
...
- **Modified: `src/FxMap/Cached/FxMapModelCache.cs`**
...
- **Modified: `src/FxMap.HotChocolate/ApplicationModels/FxMapHotChocolateRegister.cs`**
  - Updated to use renamed FxMapModelCache method

- **Modified: `src/FxMap.HotChocolate/Resolvers/DataResolvers.cs`**
  - Updated to use renamed FxMapModelCache method

- **Modified: `src/FxMap.HotChocolate/Resolvers/FxMapObjectTypeExtension.cs`**
  - Updated to use renamed FxMapModelCache method

**NATS Integration:**

- **Modified: `src/FxMap.Nats/Implementations/NatsServer.cs`**
  - Updated to use renamed FxMapModelCache method
...
- **Deleted: `test/FxMap.Benchmark/FxMapBenchmarks/Reflections/MappableModels.cs`** (32 lines)
  - Removed legacy benchmark models

- **Deleted: `test/FxMap.Benchmark/FxMapBenchmarks/Reflections/MappablePropertiesBenchmark.cs`** (26 lines)
  - Removed legacy benchmark implementation

- **Deleted: `test/FxMap.Benchmark/FxMapBenchmarks/Reflections/ReflectionLegacy.cs`** (167 lines)
  - Removed legacy reflection implementation
  - Replaced by optimized version in ReflectionHelpers

- **Deleted: `test/FxMap.Benchmark/FxMapBenchmarks/Reflections/ReflectionWithFastCache.cs`** (62 lines)
  - Removed intermediate optimization attempt
  - Replaced by ParameterConverter

**Updated:**

- **Modified: `test/FxMap.Benchmark/FxMapBenchmarks/Reflections/MemberResponseDummy.cs`**
  - Updated to work with new benchmark infrastructure

- **Modified: `test/FxMap.Benchmark/Program.cs`**
...
|-----------|----------------|----------------|
| **Core Helpers** | `src/FxMap/Helpers/ParameterConverter.cs` | Added          |
| | `src/FxMap/Helpers/ReflectionHelpers.cs` | Optimized      |
| **Core Implementation** | `src/FxMap/Implementations/DistributedMapper.cs` | Updated        |
| **Exceptions** | `src/FxMap/Exceptions/FxMapException.cs` | Extended       |
| **Assembly Info** | `src/FxMap/Properties/AssemblyInfo.cs` | Added          |
| **Cache** | `src/FxMap/Cached/FxMapModelCache.cs` | Renamed        |
| **HotChocolate** | `src/FxMap.HotChocolate/ApplicationModels/FxMapHotChocolateRegister.cs` | Updated        |
| | `src/FxMap.HotChocolate/Resolvers/DataResolvers.cs` | Updated        |
| | `src/FxMap.HotChocolate/Resolvers/FxMapObjectTypeExtension.cs` | Updated        |
| **NATS** | `src/FxMap.Nats/Implementations/NatsServer.cs` | Updated        |
| **Tests** | `test/FxMap.Tests/UnitTests/Helpers/ParameterConverterTests.cs` | Added (13 tests) |
| | `test/FxMap.Tests/UnitTests/Helpers/ReflectionHelpersCircularReferenceTests.cs` | Added (19 tests) |
| **Benchmarks** | `test/FxMap.Benchmark/FxMapBenchmarks/Reflections/DiscoverResolvablePropertiesBenchmark.cs` | Added          |
| | `test/FxMap.Benchmark/Program.cs` | Updated        |
| | `test/FxMap.Benchmark/FxMapBenchmarks/Reflections/MemberResponseDummy.cs` | Updated        |
| **Removed** | `test/FxMap.Benchmark/FxMapBenchmarks/Reflections/MappableModels.cs` | Deleted        |
| | `test/FxMap.Benchmark/FxMapBenchmarks/Reflections/MappablePropertiesBenchmark.cs` | Deleted        |
| | `test/FxMap.Benchmark/FxMapBenchmarks/Reflections/ReflectionLegacy.cs` | Deleted        |
| | `test/FxMap.Benchmark/FxMapBenchmarks/Reflections/ReflectionWithFastCache.cs` | Deleted        |
...
| `5cb830b` | Update naming for FxMapModelCache.GetModelAccessor | 15 files (23 insertions, 312 deletions) |
...
```bash
dotnet add package FxMap --version 8.2.6
```
...
**FxMap 8.2.6** - Major Performance Improvements
